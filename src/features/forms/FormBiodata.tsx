...
const Biodata = () => {
    ...
    return (
        <div>
            <div>
                <h1 className="text-[12px] sm:text-[16px]">Mulai Dari</h1>
            ...
            <div className='flex mb-5 font-inter flex-col mt-[15px]'>
                <label htmlFor="nama" className="text-[14]">Nama</label>
                    <h3 className="mt-2 bg-[#F4F7FA] text-[14px] sm:text-[16px] rounded-xl pl-3 w-full p-3">{biodataData.nama}</h3>
            </div>

            <div className='flex my-5 font-inter flex-col '>
                <label htmlFor="tanggal" className="text-[14]">Tanggal</label>
                    <h3 className="mt-2 bg-[#F4F7FA]  text-[14px] sm:text-[16px] rounded-xl pl-3 w-full p-3">{biodataData.tanggal}</h3>
            </div>

            <div className='flex my-5 font-inter flex-col '>
                <label htmlFor="keperluan" className="text-[14]">Keperluan</label>
                    <h3 className="mt-2 bg-[#F4F7FA]  text-[14px] sm:text-[16px] rounded-xl pl-3 w-full p-3">{biodataData.keperluan}</h3>
            </div>

            <div className='flex mt-6 flex-col'>
                <label htmlFor='nomer' className="text-[14]">No HP</label>
                <div className="relative flex items-center">
                    <h3 className="mt-2 bg-[#F4F7FA] text-[14px] sm:text-[16px] rounded-xl pl-3 w-full p-3">{biodataData.nomor}</h3>
                </div>
            </div>
            ...
            <div className='flex mt-6 flex-col'>
                ...
                <div className="relative flex items-cent er">
                    <h3 className="mt-2 bg-[#F4F7FA] text-[14px] sm:text-[16px] rounded-xl pl-3 w-full p-3">{biodataData.alamat}</h3>   
                </div>
            </div>
        </div>
    );
