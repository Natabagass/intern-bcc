                        ...
                        <div className="flex flex-col shadow-lg">
                            <div className="mx-[30px] mt-5">
                                <div className="flex flex-row w-full justify-between">
                                    <h1 className="font-bold text-[28px]">{step === 1 ? 'Akun Saya' : step === 2 ? 'Ubah Profile' : step === 3 ? 'Riwayat Transaksi' : step === 4 ? 'Ubah Password' : 'Akun Saya'}</h1>
                                    <div className="flex flex-row items-center">
                                        <button onClick={() => setStep(1)} className={`${step === 2 ? 'flex items-center text-[14pxpx] mr-5 cursor-pointer text-[#F78CB2] border border-[#F78CB2] p-2 rounded-lg' : 'hidden'}`}><icons.IoMdArrowRoundBack className=" mr-2" />Kembali</button>
                                        <button onClick={() => setStep(2)} className={`${step === 4 ? 'flex items-center text-[20px] mr-5 cursor-pointer' : 'hidden'}`}><icons.IoMdArrowRoundBack className="text-[#F78CB2]" /></button>
                                        <button onClick={() => setStep(4)} className={`${step === 2 ? 'flex bg-[#F78CB2] hover:bg-white hover:border hover:text-[#F78CB2] hover:border-[#F78CB2] text-[14px] p-2 rounded-lg text-white' : 'hidden'}`}>Ubah Kata Sandi</button>
                                    </div>
                            ...
                            <div className="mt-5">
                                ...
                                <div className="relative flex flex-col items-center">
                                    <Input
                                        ...
                                        className="mt-3 pl-5 p-3 placeholder:text-[14px] rounded-lg bg-[#FEF8FA]" />
